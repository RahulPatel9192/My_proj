 ...
 * Description: 
 * @Ex_4_10_getline.c   
 * @An alternate organization uses getline to read an entire input line; this makes getch and ungetch unnecessary. Revise the
...
int main(void)
{
    int type,i;              /*Which type of data is present numeric or sign*/
