...
/* array of pointer which contanies name of month */
char *name[] = { "Illegal month", "Jan", "Feb", "Mar","April","May", /* changes here */
                 "June","July","Sep","Oct","Nov","Dec"};

/* day_of_year: set day of year from month & day */

int day_of_year(int year, int month, int day)
{
    int i, leap;                                /* change here */
